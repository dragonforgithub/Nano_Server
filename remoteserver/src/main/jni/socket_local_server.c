 ...
 */
int nano_socket_local_server_bind(int s, const char* name, int namespaceId) {
 ...
 */
int nano_socket_local_server(const char* name, int namespaceId, int type) {
  int err;
  int s;
  ...
  err = nano_socket_local_server_bind(s, name, namespaceId);
